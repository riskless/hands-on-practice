...
public class UsersController {
	...
	// Main Functions: Create new user (Registration), User Login, Get/Update/Delete User Details, 
	...
	// localhost:<port>/users/status/check
	// Zuul API Gateway (localhost:8011/users-ws/users/status/check)
